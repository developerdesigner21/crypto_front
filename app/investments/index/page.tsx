            ...
            <div className="flex flex-col justify-center items-center min-h-screen bg-surface tf-container">
                        ...
                        <div className="p-6">
                            <div className="flex justify-between items-center mb-6">
                                <div className="flex items-center gap-3">
                                    <div>
                                        <h2 className="font-semibold text-lg">Investment Overview</h2>
                                    </div>
                                </div>
                                <a href="/investments/plans" className="flex items-center text-white gap-[4px] p-2 rounded-xl bg-white/5 hover:bg-white/10 transition-colors">
                ...
                <div className="pt-[5px] pb-[80px] relative w-full max-w-[672px] mx-auto">
                    <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-6 mb-6 border border-white/10" style={{ paddingTop: '2px' }}>
                        <div className="mt-8">
                            <h2 className="text-lg font-semibold mb-4">My Investment Logs</h2>
                            <div className="flex flex-col gap-4 pt-2">
                                <p className="mt-4 text-yellow-500">No Investments yet.</p>
                            </div>
                        </div>
                    </div>
                </div>
